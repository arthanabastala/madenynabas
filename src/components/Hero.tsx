    ...
    <section className="relative min-h-screen pt-32 pb-24 overflow-hidden flex items-center">
      <div className="mx-auto max-w-7xl px-8 w-full relative z-10 grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        >
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 w-full max-w-[500px] lg:max-w-[540px] aspect-[16/10] bg-card-dark rounded-2xl border border-white/[0.08] shadow-2xl shadow-black/80 overflow-hidden transform-gpu rotate-2 hover:rotate-1 transition-transform duration-700 z-0">
            {/* Window Controls */}
          ...
          <div className="absolute left-0 bottom-8 lg:left-4 lg:bottom-12 w-[180px] h-[380px] bg-bg-dark rounded-[2rem] border border-white/[0.12] shadow-2xl shadow-black/90 overflow-hidden transform-gpu -rotate-6 hover:-rotate-4 transition-transform duration-700 z-10">
            {/* Notch */}
